...
const SamplePage = () => {
  ...
  const handleAlert = () => {
    dispatch(
      addNotification({
        variant: 'success',
        title: 'HAC Dev Test Notification',
        description: 'Sent a notification successfully.',
      }),
    );
  };
  ...
  return (
    <React.Fragment>
      <PageHeader>
        <PageHeaderTitle title="Sample HAC Dev App" />
        <p> This is test for HAC Dev environment. </p>
      </PageHeader>
      <Main>
        <Stack hasGutter>
          <StackItem>
